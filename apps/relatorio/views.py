...
def obter_dados_tendencia(request):
    ...
    dados_tendencia_questao_1 = [dados.filter(questao_1=1).count(), dados.filter(questao_1=2).count(), dados.filter(questao_1=3).count(),
                                 dados.filter(questao_1=4).count(), dados.filter(questao_1=5).count()]

    dados_tendencia_questao_2 = [dados.filter(questao_2=1).count(), dados.filter(questao_2=2).count(),
                                 dados.filter(questao_2=3).count(),
                                 dados.filter(questao_2=4).count(), dados.filter(questao_2=5).count()]

    dados_tendencia_questao_3 = [dados.filter(questao_3=1).count(), dados.filter(questao_3=2).count(),
                                 dados.filter(questao_3=3).count(),
                                 dados.filter(questao_3=4).count(), dados.filter(questao_3=5).count()]

    dados_tendencia_questao_4 = [dados.filter(questao_4=1).count(), dados.filter(questao_4=2).count(),
                                 dados.filter(questao_4=3).count(),
                                 dados.filter(questao_4=4).count(), dados.filter(questao_4=5).count()]

    dados_tendencia_questao_5 = [dados.filter(questao_5=1).count(), dados.filter(questao_5=2).count(),
                                 dados.filter(questao_5=3).count(),
                                 dados.filter(questao_5=4).count(), dados.filter(questao_5=5).count()]

    dados_tendencia_questao_6 = [dados.filter(questao_6=1).count(), dados.filter(questao_6=2).count(),
                                 dados.filter(questao_6=3).count(),
                                 dados.filter(questao_6=4).count(), dados.filter(questao_6=5).count()]
    ...
    dados_retorno_tendencia = {
        "tendencia_questao_1": {
            ...
            "moda": obter_moda(dados_tendencia_questao_1),
        },
        "tendencia_questao_2": {
            ...
            "moda": obter_moda(dados_tendencia_questao_2),
        },
        "tendencia_questao_3": {
            ...
            "moda": obter_moda(dados_tendencia_questao_3),
        },
        "tendencia_questao_4": {
            ...
            "moda": obter_moda(dados_tendencia_questao_4),
        },
        "tendencia_questao_5": {
            ...
            "moda": obter_moda(dados_tendencia_questao_5),
        },
        "tendencia_questao_6": {
            ...
            "moda": obter_moda(dados_tendencia_questao_6),
        }
    }
